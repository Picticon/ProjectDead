 ...
 * The event is **not** cancellable.
*/
declare function onEvent(name: "ftbquests.completed.38E3CAB30211961D", handler: (event: Internal.QuestObjectCompletedEventJS) => void);
/**
 * 
 * The event fires on: **startup**, **server**.
 * 
 ...
 * The event is **not** cancellable.
*/
declare function onEvent(name: "ftbquests.started.79B4216ED226B6B7", handler: (event: Internal.QuestObjectStartedEventJS) => void);
/**
 * 
 * The event fires on: **startup**, **client**.
 * 
 ...
 * The event is **not** cancellable.
*/
declare function onEvent(name: "ftbquests.completed.79B4216ED226B6B7", handler: (event: Internal.QuestObjectCompletedEventJS) => void);
/**
 * 
 * The event fires on: **startup**.
 * 
 ...
 * The event is **not** cancellable.
*/
declare function onEvent(name: "ftbquests.started.38E3CAB30211961D", handler: (event: Internal.QuestObjectStartedEventJS) => void);
/**
 * 
 * The event fires on: **startup**, **server**.
 * 
...
declare function onForgeEvent(name: "com.brandon3055.brandonscore.api.event.TileBCoreInitEvent", handler: (event: Internal.TileBCoreInitEvent) => void);
...
declare function onForgeEvent(name: "wayoftime.bloodmagic.event.SacrificeKnifeUsedEvent", handler: (event: Internal.SacrificeKnifeUsedEvent) => void);
